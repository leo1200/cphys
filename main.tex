...
% problems with tocbasic 
% in newest LaTeX version
% \usepackage{tocbasic}
...
% avoid weird error in the newest 
% LaTeX version
\newcounter{tcolorboxnumber}
...
% Add warning at top of every page
\AddToShipoutPictureBG{%
  \AtPageUpperLeft{%
    \raisebox{-1.8\baselineskip}{%
      \makebox[\paperwidth]{%
        \hfill
        \scriptsize\textcolor{darkorange}{\textbf{Version 0.03: Expect errors (report under \href{https://github.com/leo1200/cphys/issues}{https://github.com/leo1200/cphys/issues}) and cross-check formulas before implementation.}}
        \hfill
      }%
    }%
  }%
...
\import{sections/}{4_5_bias_var.tex}
\import{sections/}{4_6_class.tex}
\import{sections/}{4_7_NN.tex}
\import{sections/}{4_8_dim.tex}
\import{sections/}{4_9_latent.tex}

\part{Scientific Machine Learning}
\import{sections/}{5_1_diff_sim.tex}

% \import{sections/}{5_0_summaries.tex}
% \import{sections/}{5_1_FOSM.tex}
% \import{sections/}{5_2_CSDA.tex}

\import{sections/}{7_questions.tex}
