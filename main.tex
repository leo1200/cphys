...
\AddToShipoutPictureBG{%
  \AtPageUpperLeft{%
    \raisebox{-1.8\baselineskip}{%
      \makebox[\paperwidth]{%
        \hfill
        \scriptsize\textcolor{darkorange}{\textbf{Version 0.01: Expect errors (report under \href{https://github.com/leo1200/jf1uids/issues}{github.com/leo1200/jf1uids/issues}) and cross-check formulas before implementation.}}
        \hfill
      }%
    }%
  }%
