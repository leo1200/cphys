...
\AddToShipoutPictureBG{%
  \AtPageUpperLeft{%
    \raisebox{-1.8\baselineskip}{%
      \makebox[\paperwidth]{%
        \hfill
        \scriptsize\textcolor{darkorange}{\textbf{Version 0.02: Expect errors (report under \href{https://github.com/leo1200/cphys/issues}{https://github.com/leo1200/cphys/issues}) and cross-check formulas before implementation.}}
        \hfill
      }%
    }%
  }%
