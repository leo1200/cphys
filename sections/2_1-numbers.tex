...
\redbox{\textbf{Implicit type conversion:} In C, the type can implicitly be converted up to signed int, which can avoid overflow, as illustrated in table \ref{tab:type_conversion}.
}
\begin{table}[!htb]
    \centering
