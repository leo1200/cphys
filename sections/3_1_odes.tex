...
no good conservation properties though.}\footnote{A system of differential equations
\begin{equation*}
  \begin{aligned}
    \partial_t \vec{u} &= \vec{f}(\vec{u},\vec{v}) \\
    \partial_t \vec{v} &= \vec{g}(\vec{v},\vec{v})
  \end{aligned}
\end{equation*}
is reversible if
\begin{equation*}
  \begin{aligned}
    \vec{f}(\vec{u},-\vec{v}) &= -\vec{f}(\vec{u},\vec{v}) \\
    \vec{g}(\vec{v},-\vec{v}) &= \vec{g}(\vec{v},\vec{v})
  \end{aligned}
\end{equation*}
}}
